...
<section class="aq-about-hero">
  <div class="aq-container aq-about-hero-inner">
    <div class="aq-about-hero-card">
      <div class="aq-about-hero-titlebar">
        <h1>WE ARE ALAS QUATRO</h1>
        <p>Four Wings. One Vision. A Post-Polluted Manila.</p>
      </div>
...
<section class="aq-about-who">
  <div class="aq-container aq-about-who-inner">
    <div class="aq-about-who-card">
      <div class="aq-about-who-copy">
        <h2>WHO WE ARE?</h2>
        <div class="aq-about-divider">
          <span></span><span class="dot"></span><span></span>
        </div>
        <p>
          Alas Quatro is a four-person independent game development team composed of passionate game designers,
          programmers, and artists committed to creating meaningful and socially relevant gaming experiences.
          We believe that games have the power to educate, inspire, and spark change — and that belief drove us
          to create <em>100 Days in Metro Manila</em>.
        </p>
        <p>
          Our work draws from our roots and our love for Metro Manila — a city of extraordinary resilience and
          beauty, facing very real environmental challenges. Through interactive storytelling, we hope to
          translate the urgency of the United Nations Sustainable Development Goals into something that players
          can feel, experience, and reflect upon long after they put the game down.
        </p>
      </div>

      <div class="aq-about-pillars">
        <div class="aq-about-pillar">
          <h3>MISSION</h3>
          <div class="aq-about-pillar-divider"></div>
          <p>
            To develop purposeful, engaging, and culturally rooted video games that inspire players to reflect
            on real-world environmental and social challenges — specifically those affecting the Philippines —
            while delivering an immersive and emotionally resonant gameplay experience.
          </p>
        </div>
        ...
        <div class="aq-about-pillar">
          ...
          <div class="aq-about-pillar-divider"></div>
          <p>
            To become a leading Filipino game studio recognized for creating narrative-driven games that
            champion environmental awareness and cultural identity — proving that independent Filipino
            developers can produce world-class experiences that carry meaningful, lasting social impact.
          </p>
        </div>
      </div>
    </div>
...
<section class="aq-about-team">
  <div class="aq-container aq-about-team-inner">
    <h2 class="aq-about-team-title">ALAS QUATRO</h2>
